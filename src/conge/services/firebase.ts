...
const firebaseConfig = {
  ...
  appId: import.meta.env.VITE_FIREBASE_APP_ID || '1:126755156140:web:1e913077a929fb0b7eaf09',
};
...
export { app, auth, database, database as db, getFirebaseDatabase, getFirebaseAuth };
